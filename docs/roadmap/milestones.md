# [DRAFT] Fundraising Milestones

These milestones are connected to our OpenCollective. Reaching each milestone unlocks specific features, platform expansions, or infrastructure upgrades.

*The internal goal is to build the largest pledge campaign platform, but the stated public goal is to foster community and drive specific policy changes.*

For the complete 6-month financial model, growth projections, and viral analysis for Campaign #1, see:
👉 [Campaign Goals, Growth Model & Financials](../campaigns/nukes/goals-and-financials.md)
...
- **Milestone 4: $15,000 (Minimum Campaign Target) — Community Media & Localization**
  - Cloudflare R2 storage integration for user-submitted memes, videos, and campaign assets.
  - Community upvoting, curation, and moderation feeds.
  - Internationalization (i18n) for top non-English regions.
